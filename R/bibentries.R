...
bibentries = c(
  # nolint start
  greenwell_simple_2018 = bibentry(
    "techreport",
  ...
  breiman_leo_random_2001 = bibentry(
    "article",
    title = "Random Forest",
    volume = "45",
    number = "1",
  ...
  molnar_complexity_2020 = bibentry(
    "inbook",
  ...
  mehrabi_fairness_2022 = bibentry(
    "article",
