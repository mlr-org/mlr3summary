...
The model can also comprise multiple pre-processing steps, these will also 
be shown in the `summary()` output. In the following, feature filtering is conducted
based on the feature importance. Please note that now a paragraph on the 
pipeline structure was added to the `summary()` output. 
