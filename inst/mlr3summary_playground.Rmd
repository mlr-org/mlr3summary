...
```{r importances}
sm = summary(mod_rpart, rrcv3, control = summary_control(importance_measures = c("pfi", "pdp")))
```


Only display `n_important = 3L` most important features. 
```{r n_important}
summary(mod_rpart, rrcv3, control = summary_control(importance_measures = c("pdp"), n_important = 3L))
```
